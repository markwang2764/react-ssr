            ...
            inputDom = React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'label',
                        null,
                        React.createElement('input', { type: 'text', value: data.text, ref: function ref(input) {
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'label',
                        null,
                        React.createElement('input', { type: 'password', value: data.password, onChange: onChange, placeholder: placeholders[1] })
                    )
                )
            );
            break;
            ...
            inputDom = React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'label',
                        null,
                        React.createElement('input', { type: 'password', value: data.password, ref: function ref(input) {
                                return focusFn(input);
                            }, onChange: onChange, placeholder: placeholders[0] })
                    )
                )
